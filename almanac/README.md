...
- [Toolkit pattern](architecture/toolkit-pattern) — the shared mental model (CLI and MCP server are thin dispatch layers over `<Name>Toolkit` classes); the 7 toolkit classes, method conventions, dependency map
